...
define(['three', 'pubsub'], function (THREE, PubSub) {
  ...
  var rtTextureColor, rtTextureDepth, scene, camera, materialDepth;
  ...
  PubSub.subscribe('render-scene', function(msg, data) {
	data.renderer.render(data.scene, data.camera, rtTextureColor, true );

	// Render depth into texture
	data.scene.overrideMaterial = materialDepth;
	data.renderer.render(data.scene, data.camera, rtTextureDepth, true );
