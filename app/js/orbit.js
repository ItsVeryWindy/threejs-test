...
THREE.OrbitControls.prototype = Object.create( THREE.EventDispatcher.prototype );
  ...
  PubSub.subscribe('init-scene', function(msg, data) {
	controls = new THREE.OrbitControls(data.camera);
  ...
  PubSub.subscribe('scene-frame', function(msg, evt) {
	...
	spotLight.position.x = evt.camera.position.x;
	spotLight.position.y = evt.camera.position.y;
	spotLight.position.z = evt.camera.position.z;
  });
});